...
val modId = "$mod_id-mcef"
val modName = "$mod_name-mcef"

group = "${mod_group_id}.mcef"
...
dependencies {
    ...
    modImplementation("org.montoyo:mcef:1.12.2-1.11b")
    implementation(project(":"))
    // https://ds58-mcef-mirror.ewr1.vultrobjects.com/
}
