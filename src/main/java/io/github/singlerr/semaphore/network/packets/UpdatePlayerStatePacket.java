...
@NoArgsConstructor
@AllArgsConstructor
public class UpdatePlayerStatePacket extends Packet {
    ...
    public static class Handler extends PacketHandler<UpdatePlayerStatePacket> {

        @Override
        protected Packet handleC2S(MessageContext ctx, UpdatePlayerStatePacket packet) {
        ...
        @Override
        protected Packet handleS2C(MessageContext ctx, UpdatePlayerStatePacket packet) {
            PlayerContext context = packet.getPlayerState();
