...
@Log4j2
public class PhoneScreen extends IngameListScreenBase {
    ...
    public void initGui() {
        ...
        this.addressList = new AddressList(this, this.guiLeft + 64 , frameWidth + CORNER_WIDTH, frameHeight, this.guiTop + CORNER_HEIGHT - 16, SLOT_HEIGHT);
